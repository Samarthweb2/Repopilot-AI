...
export function AuthModal({ onAuthSuccess }: AuthModalProps = {}) {
  ...
  useEffect(() => {
    ...
    initGsi()
    const timer = setTimeout(initGsi, 250)
    return () => clearTimeout(timer)
  }, [authModalMode, mode, loginWithGoogleCredential, onAuthSuccess])
      ...
      >
        ...
        <div className="px-7 pb-7 space-y-4">
          ...
          <div className="space-y-2.5">
            {/* Google Identity Official Sign-In Button */}
            <div
              ref={googleBtnContainerRef}
              id="google-signin-container"
              className="w-full flex justify-center overflow-hidden rounded-xl min-h-[42px]"
            />
